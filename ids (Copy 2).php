					...
					if(eregi("zone",$d0main)){
						...
						if(strlen(trim($domains[1][0])) > 2){
							...
							echo "<tr>
								...
								<td>".$user['name']."</td>
								<td><a href='$full/kuda_sym/root/home/".$user['name']."/public_html' target='_blank'>Symlink</a></td>
							</tr>";
							flush();
							$dcount++;
						}
				...
				<table class='text-center table-responsive'>
					...
					while(!feof($file)){
						...
						echo "<tr>
							...
							<td><a href=$full/kuda_sym/root/home/".$matches."/public_html target='_blank'>Symlink</a></td>
						</tr>";
						$dcount++;
					}
					fclose($file);
